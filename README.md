...
- C.M. Bishop, Pattern Recognition and Machine Learning (2009), Springer. <a href="https://www.microsoft.com/en-us/research/publication/pattern-recognition-machine-learning/" target="_blank">Book website</a>

- C.E. Rasmussen & C.K.I. Williams, Gaussian Processes for Machine Learning (2006), MIT Press. <a href="https://gaussianprocess.org/gpml/chapters/RW.pdf" target="_blank">Book website</a>

## Lecture slides

Slides for this part of the course can be downloaded {download}`here<https://surfdrive.surf.nl/files/index.php/s/zWbRuDL1rjrUQF5/download>`. The linked PDF will be automatically updated in case the slides are modified.
